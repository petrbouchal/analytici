...
Využíváme [data ČSÚ ze SLDB o obydlenosti bytů v obcích](https://www.czso.cz/csu/czso/vysledky-scitani-2021-otevrena-data).
...
byty_podily |>
  ...
  theme_ptrr("scatter")
```
Mediánový podíl obydlených bytů je `r round(median(byty_podily$obydlenost_share) * 100)` %. (*Toto číslo se do věty doplňuje automaticky z živých dat*)
...
byty_podily |> 
  ...
  geom_label(aes(label = kraj_nazev_short))
```
